export default class Templates{
    ...
    OptionsCreator() {
        ...
        dropdown.setAttribute("class", "absolute opacity-dropdown");
    ...
    OptionsBlock(){
        ...
        <div class="rounded-md bg-white dark:bg-[#242424] py-2">
            <div class="flex flex-col px-2">
              <input
                type="search"
                class="outline-none pl-2 py-1 font-light rounded-sm dark:bg-[#3b3d3d]"
              ...
              <div class="w-full h-full p-2">
                <div class="flex flex-col justify-start">
                  ...
                  <div class="cursor-pointer text-gray-400 flex items-center gap-1 p-2 hover:bg-[#3b3d3d] rounded-md transition-all duration-300">
                    ...
                    <span class="ml-2 text-md">Color</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        const dropdown = document.createElement("div");
        dropdown.setAttribute("class", "absolute opacity-dropdown");
        dropdown.setAttribute("data-dropdown-content", "option_block");
        dropdown.innerHTML = HTML;
        return dropdown;
    }
    ...
    getlistTemplate(type){
        switch (type){
            ...
            case "option_block" : 
                return  this.listTemplates.block;
            default : return
        }
    }
}
